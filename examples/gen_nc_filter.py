...
to a NETCONF XML filter.  It is designed to work with the output of
pwc json-instance-path command on SR OS, which provide YANG paths
for configuration and state data.

It can be used with any NETCONF clients that require subtree filters,
including Ansible automation and ncclient.
