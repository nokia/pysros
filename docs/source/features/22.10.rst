...
* :py:meth:`pysros.management.Connection.action` method provides the ability to execute a YANG modelled
  action (operation) on SR OS using modelled, structured data as both input and output.
